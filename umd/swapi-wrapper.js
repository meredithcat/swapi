(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('stream'), require('http'), require('url'), require('https'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'stream', 'http', 'url', 'https', 'zlib'], factory) :
    (global = global || self, factory(global.swapiWrapper = {}, global.Stream, global.http, global.Url, global.https, global.zlib));
}(this, function (exports, Stream, http, Url, https, zlib) { 'use strict';
